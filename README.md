...
- **usiGrabber**: We make proteomics data accesible for data scientist through a unified database for metadata. We are a team of 5 students and part of the Chair for Data Analytics and Computational Statistics at HPI.
- **Security for Android Apps**: As part of a lecture on mobile security, we are working on an android note taking app.
